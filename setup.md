...
1. Download [data-shell-scripting.zip][zip-file] and move the file to your Desktop.
2. Unzip/extract the file.
   **Let your instructor know if you need help with this step**.
   You should end up with a new folder called **`data-shell-scripting`** on your Desktop.
3. Open a terminal.
